        ...
        <div className="pr-4 border-r border-white flex flex-col justify-center">
          ...
          <form className="ml-7">
            <div className="text-left">
              ...
              <input type="text" placeholder="Enter your ID" id="userid" className="w-72 px-4 py-2 rounded text-gray-700 font-raleway focus:outline-none border border-gray-300" />
            </div>
            <div className="text-left mt-5">
              <label htmlFor="password" className="block text-white font-normal mb-1">Password</label>
              <input type="password" placeholder="Enter the password" id="password" className="w-72 px-4 py-2 rounded text-gray-700 font-raleway focus:outline-none border border-gray-300" />
            </div>
            <div className="mt-10 mr-6 text-center">
              <button type="button" onClick={login} className="w-32 font-medium border-solid border-white border bg-white text-[#407B7B] py-2 rounded-2xl hover:bg-[#407B7B] hover:text-white">
                Submit
              </button>
            </div>
          </form>
